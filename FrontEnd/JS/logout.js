// ==========================================
// STANDALONE LOGOUT COMPONENT
// Injects HTML, CSS, and Logic dynamically.
// ==========================================

class LogoutManager {
    constructor() {
        // Wait for the DOM to be fully loaded before injecting
    ...
    init() {
        // Only initialize if the trigger button actually exists on this page
    ...
    injectCSS() {
        ...
        style.textContent = `
            ...
            .Logout-Card {
                ...
                width: 62.5rem;
                height: 37.5rem;
                padding: 3.2rem 0.63rem 0.63rem 0.63rem;
                flex-direction: column;
                align-items: center;
                gap: 1.57rem;
                border-radius: 0.9375rem;
                border: 2px solid var(--Control-Gray);
